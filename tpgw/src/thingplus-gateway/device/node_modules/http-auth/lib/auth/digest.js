...
(function() {
  ...
  Digest = (function(_super) {
    ...
    Digest.prototype.parseAuthorization = function(header) {
      var clientOptions, name, sepIndex, token, tokens, value, _i, _len;
      clientOptions = {};
      tokens = header.split(",");
      if ((tokens[0].substr(0, 6)) === "Digest") {
        tokens[0] = tokens[0].substr(7);
        clientOptions = {};
        for (_i = 0, _len = tokens.length; _i < _len; _i++) {
          token = tokens[_i];
          token = token.trim();
          sepIndex = token.indexOf("=");
          name = token.substr(0, sepIndex);
          value = token.substr(sepIndex + 1);
          if ((value.indexOf("\"")) !== -1) {
