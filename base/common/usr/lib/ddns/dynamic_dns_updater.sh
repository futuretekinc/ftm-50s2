...
do
	...
	then
		...
		echo "Update Output:" > "/var/run/dynamic_dns/$service_id.log"
		verbose_echo "$update_output"
		echo "$update_output" >> "/var/run/dynamic_dns/$service_id.log"
		verbose_echo ""
		echo "" >> "/var/run/dynamic_dns/$service_id.log"
		...
		echo "update complete, time is: $human_time" >> "/var/run/dynamic_dns/$service_id.log"
